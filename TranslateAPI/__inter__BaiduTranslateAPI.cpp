...
BaiduTranslateAPI::BaiduTranslateAPI(const _STD string& appid, const _STD string& appkey) noexcept:
	m_TranslateInfo({ .appid = appid, .appkey = appkey })
{
	try
	{
		...
		{
			if (!BaiduTranslateSetAppID(appid, appkey))
			{
				const auto&				source_location { _STD source_location::current() };
...
BaiduTranslateAPI::~BaiduTranslateAPI(void) noexcept
{
	if (m_pCurl != nullptr)
	{
...
_NODISCARD bool BaiduTranslateAPI::BaiduTranslateSetAppID(const _STD string& appid, const _STD string& appkey) noexcept
{
...
_STD string BaiduTranslateAPI::BaiduTranslateTranslate(_STD string_view source,
...
InterBaiduTranslateAPIRuntimeStatus* BaiduTranslateAPI::whatHappened(void) const noexcept
{
	return m_pBaiduTranslateAPIRuntimeStatus.get();
}

_STD size_t BaiduTranslateAPI::
...
_STD string BaiduTranslateAPI::InterSourceEncode(const _STD string& source)
{
...
_STD string BaiduTranslateAPI::InterGetURL(const _STD string& source, const _STD string& from, const _STD string& to)
	noexcept(false)
{
...
_STD string BaiduTranslateAPI::InterGetErrorInfo(const _STD string& errorCode) noexcept
{
...
_STD string BaiduTranslateAPI::InterTranslate(void) noexcept(false)
{
	if (m_TranslateInfo.appid.empty() || m_TranslateInfo.appkey.empty())
	{
		const auto&				source_location { _STD source_location::current() };
	...
	curl_easy_setopt(m_pCurl, CURLOPT_WRITEFUNCTION, &BaiduTranslateAPI::InterWriteCallback);
