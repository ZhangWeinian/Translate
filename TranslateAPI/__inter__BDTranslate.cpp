...
_STD string __inter__BDTranslate::InterBaiduTranslateTranslate(_STD string_view source,
															   ...
															   _STD string_view to) noexcept
{
	...
	_STD string url { _STD move(InterGetURL(m_TranslateInfo.source, m_TranslateInfo.from, m_TranslateInfo.to)) };
...
_STD size_t __inter__BDTranslate::
	InterWriteCallback(const char* data, _STD size_t size, _STD size_t nmemb, _STD string* userdata) const noexcept
{
...
_STD string __inter__BDTranslate::InterGetURL(const _STD string& source,
