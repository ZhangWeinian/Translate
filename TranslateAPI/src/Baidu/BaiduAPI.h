...
namespace CPPBaiduTranslateDLL
{
	...
	class CPPBaiduTranslateFunction final: public ErrorDefine::MaxInitCount<CPPBaiduTranslateFunction, 1>
	{
	public:
		CPPBaiduTranslateFunction(const _STD string& appid = "", const _STD string& appkey = "") noexcept;

		~CPPBaiduTranslateFunction(void) noexcept override;
