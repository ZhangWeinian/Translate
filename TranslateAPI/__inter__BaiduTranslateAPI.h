...
public:
	...
	explicit BaiduTranslateAPI(const _STD string& appid, const _STD string& appkey) noexcept;
	...
	/// <returns>无返回值</returns>
	~BaiduTranslateAPI(void) noexcept;
	...
	_NODISCARD bool BaiduTranslateSetAppID(const _STD string& appid, const _STD string& appkey) noexcept;
	...
	_STD string BaiduTranslateTranslate(_STD string_view source, _STD string_view from, _STD string_view to) noexcept;
