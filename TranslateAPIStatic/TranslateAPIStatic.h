...
public:
	...
	static void BDTranslate(const _STD string& appid, const _STD string& appkey) noexcept;
	...
	_NODISCARD static bool SetAppID(const _STD string& appid, const _STD string& appkey) noexcept;
